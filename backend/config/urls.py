...
urlpatterns = [
    ...
    # API v1 - 사용자
    path(
        "api/v1/users", UserMeView.as_view(), name="user-me"
    ...
    # API v1 - 버스 노선 정보
    path(
        "api/v1/bus/routes/search",
        BusRouteSearchView.as_view(),
        name="bus-route-search",
    ),
    path(
        "api/v1/bus/routes/batch",
        BusMultipleRoutesView.as_view(),
        name="bus-routes-batch",
    ),
    path(
        "api/v1/bus/routes/<str:route_id>/stations",
        BusRouteStationsView.as_view(),
        name="bus-route-stations",
    ),
    path(
        "api/v1/bus/routes/<str:route_id>/path",
        BusRoutePathView.as_view(),
        name="bus-route-path",
    ),
    path(
        "api/v1/bus/routes/<str:route_id>/positions",
        BusRealtimePositionsView.as_view(),
        name="bus-route-positions",
    ),
    path(
        "api/v1/bus/positions/area",
        BusAllPositionsView.as_view(),
        name="bus-positions-area",
    ),
    path(
        "api/v1/bus/positions/track",
        BusTrackPositionsView.as_view(),
        name="bus-positions-track",
    ),
    # API 문서
