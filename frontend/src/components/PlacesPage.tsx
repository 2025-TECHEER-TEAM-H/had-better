...
export function PlacesPage({ onNavigate }: PlacesPageProps) {
  ...
  const getDefaultPlaces = () => [
    { id: 'central-park', name: 'CENTRAL PARK', emoji: '🏞️', distance: '2.5 KM', status: 'OPEN', bgColor: '#7ed321', statusColor: 'white', textColor: 'black' },
    { id: 'pet-shop', name: 'PET SHOP', emoji: '🏪', distance: '0.8 KM', status: 'OPEN', bgColor: '#00d9ff', statusColor: 'white', textColor: 'black' },
    { id: 'vet-clinic', name: 'VET CLINIC', emoji: '🏥', distance: '1.2 KM', status: 'CLOSED', bgColor: 'white', statusColor: '#ff6b9d', textColor: 'black' },
    { id: 'coffee-shop', name: 'COFFEE SHOP', emoji: '☕', distance: '0.5 KM', status: 'OPEN', bgColor: '#ffc107', statusColor: 'white', textColor: 'black' },
    { id: 'bookstore', name: 'BOOKSTORE', emoji: '📚', distance: '1.5 KM', status: 'OPEN', bgColor: '#ff9ff3', statusColor: 'white', textColor: 'black' },
    { id: 'restaurant', name: 'RESTAURANT', emoji: '🍽️', distance: '1.8 KM', status: 'OPEN', bgColor: '#54a0ff', statusColor: 'white', textColor: 'white' },
    { id: 'fitness-gym', name: 'FITNESS GYM', emoji: '💪', distance: '2.0 KM', status: 'OPEN', bgColor: '#ff6348', statusColor: 'white', textColor: 'white' },
    { id: 'supermarket', name: 'SUPERMARKET', emoji: '🛒', distance: '1.0 KM', status: 'OPEN', bgColor: '#48dbfb', statusColor: 'white', textColor: 'black' },
  ];
          ...
          <div className="flex flex-col gap-4">
            {places.map(place => (
              <button
                ...
                className="rounded-[10px] border-[3.4px] border-black shadow-[4px_4px_0px_0px_black] p-5 flex gap-3 hover:scale-105 transition-transform active:translate-y-1"
              ...
              >
                ...
                <div className="flex-1 flex flex-col gap-1">
                  <p className="font-['Press_Start_2P'] text-[10px] leading-[15px]" style={{ color: place.textColor }}>{place.name}</p>
