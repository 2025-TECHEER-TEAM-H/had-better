...
interface Onboarding6PageProps {
  isOpen?: boolean;
  onNext?: () => void;
  onSkip?: () => void;
  onBack?: () => void;
...
export function Onboarding6Page({ isOpen, onNext, onSkip, onBack }: Onboarding6PageProps) {
    ...
    <div className="fixed inset-0 z-50 bg-gradient-to-b from-[#c5e7f5] to-white flex flex-col items-center justify-between overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 pt-20">
        ...
        <div className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-[#767676] text-center mb-8 text-[20px] md:text-[40px] lg:text-[40px]">
          <p className="mb-0">준비가 되었다면 엔진을 켜고</p>
        ...
        {/* 분홍 캐릭터 그룹 */}
        <div className="relative mb-8 w-[250px] h-[220px]">
          {/* 캐릭터 */}
          <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[134px] h-[134px]">
            <img 
              alt="" 
          ...
          {/* 플랫폼 왼쪽 */}
          <div className="absolute left-[35px] top-[146px] w-[70.106px] h-[70.106px]">
            <img 
              alt="" 
              className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" 
          ...
          {/* 플랫폼 중간 */}
          <div className="absolute left-[105px] top-[146px] w-[70.106px] h-[70.106px]">
            <img 
              alt="" 
              className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" 
          ...
          {/* 플랫폼 오른쪽 */}
          <div className="absolute left-[175px] top-[146px] w-[69.947px] h-[69.947px]">
            <img 
              alt="" 
              className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" 
