...
function Group1() {
  return (
    <div className="absolute bottom-[42.76px] contents left-[23.99px] right-[35.08px]">
      <div className="absolute bottom-[231.5px] font-['Wittgenstein:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium h-[188.731px] leading-[50px] left-[23.99px] right-[35.08px] text-[0px] text-[rgba(0,0,0,0.2)] text-center tracking-[0.6px] translate-y-[100%]">
...
function Group2() {
  return (
    <div className="absolute contents inset-[0_2.21px_0_1px]">
      <div className="absolute inset-[0_2.21px_0_1px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 350.791 852.029">
          <path d="M0 0H350.791V852.029H0V0Z" fill="url(#paint0_linear_105_650)" id="Rectangle 13" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_105_650" x1="175.396" x2="175.396" y1="13.6748" y2="852.03">
...
function Container() {
  return (
    <div className="absolute bg-white border-3 border-black border-solid left-[19px] rounded-[12px] shadow-[0px_4px_0px_0px_rgba(0,0,0,0.3)] size-[42px] top-[23.03px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-end left-[26px] right-[30.54px] top-[75.03px]">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[17px] items-center left-[43.79px] p-[2px] right-[48.93px] top-[86.83px]">
...
function Group() {
  return (
    <div className="absolute contents left-[26px] right-[30.54px] top-[75.03px]">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex h-[40.519px] items-center justify-center left-[283px] pl-[2.693px] pr-[2.704px] py-[2.693px] rounded-[14px] top-[25.03px] w-[40.312px]" data-name="Button">
...
function Group3() {
  return (
    <div className="absolute contents left-0 top-[0.03px]">
      <div className="absolute bg-[#80cee1] h-[198px] left-0 top-[0.03px] w-[354px]" />
      <Container />
      <p className="absolute css-4hzbpn font-['Press_Start_2P:Regular',sans-serif] h-[25.328px] leading-[30px] left-[173.77px] not-italic text-[16px] text-black text-center top-[32.03px] translate-x-[-50%] w-[195.542px]">HAD BETTER</p>
      <Group />
      <Button />
    </div>
  );
...
function Frame1() {
  return (
    <div className="absolute bg-white content-stretch flex h-[42px] items-center justify-center left-0 top-[160.03px] w-[354px]">
...
export default function Group4() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#794d4d] h-[232px] left-px top-[11.03px] w-[349px]" />
      <Group2 />
      <Group3 />
      <Frame1 />
    </div>
