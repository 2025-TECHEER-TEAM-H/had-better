    ...
    <div className="h-[159px] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center pl-[60px] pr-[111px] py-[117px] relative size-full">
          <div className="mr-[-51px] relative shrink-0 size-[160.333px]" data-name="character_green_front 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCharacterGreenFront1} />
          </div>
          <div className="mr-[-51px] relative shrink-0 size-[160.333px]" data-name="character_yellow_front 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCharacterYellowFront1} />
          </div>
          <div className="mr-[-51px] relative shrink-0 size-[160.333px]" data-name="character_purple_front 1">
...
function Frame3() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col h-[268px] items-center justify-end left-0 right-0">
      <Frame />
      <Frame1 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="absolute bg-[#4a9960] content-stretch flex h-[83px] items-center justify-center left-[25px] p-[6px] right-[25px] rounded-[40.5px] top-[350px]">
...
export default function Mobile() {
  return (
    <div className="bg-gradient-to-b from-[#c5e7f5] relative size-full to-white" data-name="Mobile">
      <p className="absolute css-4hzbpn font-['Press_Start_2P:Regular',sans-serif] leading-[60px] left-[2px] not-italic right-[-2px] text-[#1f4a2f] text-[48px] text-center top-[100px] tracking-[3.6px]">
        HAD
        <br aria-hidden="true" />
        BETTER
      </p>
      ...
      <div className="absolute left-[calc(100%+201px)] size-[128px] top-[424px]" data-name="gem_blue 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGemBlue1} />
      </div>
      <div className="absolute left-[-381px] size-[128px] top-[244px]" data-name="star 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgStar1} />
      </div>
      <div className="absolute flex items-center justify-center left-[17px] size-[122.213px] top-[204px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "21.25" } as React.CSSProperties}>
