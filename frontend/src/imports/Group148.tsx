...
function Container() {
  return (
    <div className="absolute bg-white border-3 border-black border-solid left-[19px] rounded-[12px] shadow-[0px_4px_0px_0px_rgba(0,0,0,0.3)] size-[42px] top-[23px]" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-end left-[26px] right-[30.54px] top-[75px]">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[17px] items-center left-[43.79px] p-[2px] right-[48.93px] top-[86.8px]">
...
function Group() {
  return (
    <div className="absolute contents left-[26px] right-[30.54px] top-[75px]">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex h-[40.519px] items-center justify-center left-[283px] pl-[2.693px] pr-[2.704px] py-[2.693px] rounded-[14px] top-[25px] w-[40.312px]" data-name="Button">
...
function Frame1() {
  return (
    <div className="absolute bg-white content-stretch flex h-[42px] items-center justify-center left-0 top-[160px] w-[354px]">
...
export default function Group1() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#80cee1] h-[198px] left-0 top-0 w-[354px]" />
      <Container />
      <p className="absolute css-4hzbpn font-['Press_Start_2P:Regular',sans-serif] h-[25.328px] leading-[30px] left-[173.77px] not-italic text-[16px] text-black text-center top-[32px] translate-x-[-50%] w-[195.542px]">HAD BETTER</p>
      <Group />
      <Button />
      <Frame1 />
    </div>
