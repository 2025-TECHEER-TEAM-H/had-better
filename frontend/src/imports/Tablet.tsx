...
import imgGemBlue2 from "@/assets/gem-blue.png";
...
function Frame3() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col h-[287px] items-center justify-end left-0 right-[25px]">
      <Frame />
      <Frame1 />
    </div>
  );
...
export default function Tablet() {
  return (
    <div className="bg-gradient-to-b from-[#c5e7f5] relative size-full to-white" data-name="Tablet">
      ...
      <div className="absolute flex items-center justify-center left-[48px] size-[122.213px] top-[244px]" style={{ "--transform-inner-width": "128", "--transform-inner-height": "131.75" } as React.CSSProperties}>
        <div className="flex-none rotate-[335.062deg]">
          <div className="relative size-[92px]" data-name="gem_blue 2">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGemBlue2} />
          </div>
        </div>
      </div>
      <div className="absolute right-[54px] size-[90px] top-[366px]" data-name="star 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgStar1} />
      </div>
    </div>
  );
