...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-end left-[27.96px] right-[27.93px] top-[111.98px]">
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[17px] items-center left-[45.61px] p-[2px] right-[46.17px] top-[123.62px]">
...
function Group1() {
  return (
    <div className="absolute contents left-[27.96px] right-[27.93px] top-[111.98px]">
      <Frame2 />
      <Frame3 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex h-[41.721px] items-center justify-center left-px top-[190.09px] w-[349.034px]">
      <Frame />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42.691px] items-start justify-end left-[27.96px] right-[27.93px] top-[243.45px]">
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex gap-[17px] h-[27.615px] items-center left-[46.59px] p-[2px] right-[45.19px] top-[251.21px]">
...
function Group3() {
  return (
    <div className="absolute contents left-[27.96px] right-[27.93px] top-[243.45px]">
      <Frame4 />
      <Frame5 />
    </div>
  );
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42.691px] items-start justify-end left-[27.96px] right-[27.93px] top-[297.78px]">
      <div className="bg-white h-[44px] relative rounded-[25px] shrink-0 w-full">
        <div aria-hidden="true" className="absolute border-3 border-black border-solid inset-0 pointer-events-none rounded-[25px]" />
      </div>
    </div>
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex gap-[17px] h-[27.615px] items-center left-[46.59px] p-[2px] right-[45.19px] top-[305.55px]">
...
function Group5() {
  return (
    <div className="absolute contents left-[27.96px] right-[27.93px] top-[297.78px]">
      <Frame6 />
      <Frame7 />
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents left-[24.96px] top-[422.95px]">
      <p className="absolute css-4hzbpn font-['Wittgenstein:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium h-[28.137px] leading-[30px] left-[24.96px] text-[12px] text-black top-[422.95px] tracking-[0.6px] w-[295.111px]">자주 가는 곳</p>
    </div>
  );
}
...
function Group14() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] ml-[calc(50%+89.96px)] mt-[calc(50%-47px)] relative row-1">
      <div className="col-1 ml-[calc(50%+89.96px)] mt-[calc(50%-47px)] relative row-1 size-[55px]" data-name="star 1">
...
function Frame10() {
  return (
    <div className="absolute gap-[10px] grid grid-cols-[repeat(4,_fit-content(100%))] grid-rows-[__fit-content(100%)_15.00px] leading-[0] left-[29px] top-[455px] w-[303px]">
      <Group16 />
      <Group18 />
      <Group19 />
      <Group20 />
...
function Group8() {
  return (
    <div className="absolute contents right-[30.93px] top-[571.4px]">
      <p className="absolute css-4hzbpn font-['Wittgenstein:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium h-[28.137px] leading-[30px] right-[58.38px] text-[12px] text-black text-center top-[571.4px] tracking-[0.6px] translate-x-[50%] w-[54.904px]">전체 삭제</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents left-[24.96px] top-[571.4px]">
      <p className="absolute css-4hzbpn font-['Wittgenstein:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium h-[28.137px] leading-[30px] left-[52.9px] text-[12px] text-black text-center top-[571.4px] tracking-[0.6px] translate-x-[-50%] w-[55.885px]">최근 기록</p>
      <Group8 />
    </div>
  );
}
...
function Group10() {
  return (
    <div className="absolute bottom-[42.21px] contents left-[23px] right-[32.89px]">
      <div className="absolute bottom-[228.5px] font-['Wittgenstein:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium h-[186.288px] leading-[50px] left-[23px] right-[32.89px] text-[0px] text-[rgba(0,0,0,0.2)] text-center tracking-[0.6px] translate-y-[100%]">
...
function Group13() {
  return (
    <div className="absolute bottom-0 contents left-0 top-0">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 351 841">
        <path d="M0 0H351V841H0V0Z" fill="url(#paint0_linear_85_192)" id="Rectangle 13" />
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_85_192" x1="175.5" x2="175.5" y1="13.4978" y2="841">
            <stop stopColor="#C5E7F5" />
            <stop offset="1" stopColor="white" />
          </linearGradient>
        </defs>
      </svg>
      <div className="absolute h-[40.751px] left-[24.53px] top-[30px] w-[41.178px]" data-name="lock_yellow 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgLockYellow1} />
      </div>
      <p className="absolute css-4hzbpn font-['Press_Start_2P:Regular',sans-serif] h-[25px] leading-[30px] left-[173px] not-italic text-[16px] text-black text-center top-[46px] translate-x-[-50%] w-[194px]">HAD BETTER</p>
      <Group1 />
      <Frame1 />
      <Group4 />
      <Group2 />
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col h-[42.691px] items-start justify-end left-[27.96px] right-[27.93px] top-[353.5px]">
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex h-[27.615px] items-center left-[46.59px] pb-[7px] pt-[2px] px-[2px] right-[45.19px] top-[361.26px]">
      <p className="css-4hzbpn font-['Wittgenstein:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold h-[23px] leading-[30px] relative shrink-0 text-[13px] text-black text-center w-[257px]">길 찾기</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[27.96px] right-[27.93px] top-[353.5px]">
      <Frame8 />
      <Frame9 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[278px] pl-[2.693px] pr-[2.704px] py-[2.693px] rounded-[14px] size-[39.995px] top-[31px]" data-name="Button">
